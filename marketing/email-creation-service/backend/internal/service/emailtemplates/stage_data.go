...
// StageTemplates ports STAGE_TEMPLATES verbatim.
var StageTemplates = map[string]Stage{

	"Event Announcement": {Variants: []Variant{
		{
			ID:        "v1_value_focused",
...
The Linux Foundation Events Team`,
	...
	"Registration Launch": {Variants: []Variant{
		{
...
P.S. This is a must-attend event for anyone working with cloud native and open source technologies.`,
	...
	"Co-Located Events + CFP Reminder": {Variants: []Variant{
		{
			ID:        "v1_main",
...
The Linux Foundation Events Team`,
	...
	"DEI & Travel Fund": {Variants: []Variant{
		{
			ID:        "v1_main",
...
The Linux Foundation Events Team`,
	...
	"Schedule Announcement": {Variants: []Variant{
		{
...
P.S. Bringing your team? Use the schedule to coordinate which sessions you'll each attend.`,
	...
	// Main Registration Push has no "variants" key in the Python source —
	// its subject/preheader/body are unreachable through get_template /
	// get_template_variants / get_template_variant / list_variant_strategies
	// (all of them key off "variants", which is absent here), so it is
	// dead data in Python. Preserved as dead data here rather than
	// "fixed" into a variant, per the faithful-port constraint.
	"Main Registration Push": {
		RawSubject:   "⚡ Early Bird Ends Friday – Don't Miss Your $300 Savings",
		RawPreheader: "Price increases after [Date] | 5,000+ already registered | Lock in savings now",
		RawBody: `Hi {{first_name}},
...
The Linux Foundation Events Team`,
	...
	"Final Countdown": {Variants: []Variant{
		{
			ID:        "v1_fomo_urgency",
...
The Linux Foundation Events Team`,
	...
	"Thank You + Survey": {Variants: []Variant{
		{
			ID:        "v1_main",
...
The Linux Foundation Events Team`,
	...
	"Content & Recordings Release": {Variants: []Variant{
		{
			ID:        "v1_main",
...
The Linux Foundation Events Team`,
	...
	"Next Event CFP Teaser": {Variants: []Variant{
		{
			ID:        "v1_main",
...
The Linux Foundation Events Team`,
	...
	"Community Nurture": {Variants: []Variant{
		{
			ID:        "v1_main",
