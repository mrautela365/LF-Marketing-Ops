...
# Load .env from the mcp-server root (one level above src/)
_ENV_FILE = Path(__file__).parent.parent.parent / ".env"
load_dotenv(dotenv_path=_ENV_FILE, override=False)  # env vars win over .env
...
def is_fully_configured() -> bool:
    """HubSpot is required; Asana is optional."""
